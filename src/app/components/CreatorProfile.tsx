...
import { Creator } from './types'; // Assuming 'types.ts' holds your Creator interface
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="bg-gray-900 rounded-xl p-6 shadow-lg space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-pink-600 text-sm">4 <span className="text-gray-400">new</span> · 4 total</span>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {/* Dynamically render recent photos */}
                {[...Array(4)].map((_, index) => (
                  <div key={index} className="relative rounded-lg overflow-hidden">
                    <img src={creator.image} alt="Recent photo" className="w-full h-auto object-cover" />
          ...
          <div className="w-full md:w-80 space-y-8">
            ...
            <div className="bg-gray-900 rounded-xl p-6 shadow-lg space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">Hey, baby! I'm treating you to 70% Off—don't miss out! Hit that button to SUB, and let's turn up the heat to-</p>
              </div>
              ...
              <button className="w-full py-3 rounded-lg bg-pink-600 hover:bg-pink-700 transition-colors font-bold text-lg">
                SUBSCRIBE · ${creator.price} for 31 days
              </button>
