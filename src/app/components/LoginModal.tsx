...
import { getAuth, signInWithEmailAndPassword, GoogleAuthProvider, signInWithPopup, Auth } from 'firebase/auth';

interface LoginModalProps {
  onClose: () => void;
  auth: Auth; // Accept the auth instance as a prop
}
